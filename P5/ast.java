...
class LessNode extends BinaryExpNode {
    ...
    public Type typeCheck(){
        ...
        if(typeLhs.equals(typeRhs)&&typeRhs.isIntType()){
            return boolType;
        }
        return errorType;
    }
